...
import { setUpDependencias } from "./application/dependencias";
...
export const databaseType = config.DATABASE_ENV;
...
export async function start() {
  ...
  const { playerService, rankingService } = setUpDependencias(dataBaseDetails);
